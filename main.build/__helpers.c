...
MOD_INIT_DECL( packaging$markers );
MOD_INIT_DECL( packaging$requirements );
MOD_INIT_DECL( packaging$specifiers );
MOD_INIT_DECL( packaging$version );
MOD_INIT_DECL( pos_vec );
...
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    ...
    { "ball", MOD_INIT_NAME( ball ), 0, 0, NUITKA_COMPILED_MODULE },
    { "intersect", MOD_INIT_NAME( intersect ), 0, 0, NUITKA_COMPILED_MODULE },
    { "network", MOD_INIT_NAME( network ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "numpy.distutils", NULL, 1895318, 1035, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.distutils.__config__", NULL, 1896353, 1289, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.__version__", NULL, 1897642, 348, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.ccompiler", NULL, 1897990, 19142, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.compat", NULL, 1917132, 483, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.cpuinfo", NULL, 1917615, 33480, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.exec_command", NULL, 1951095, 9259, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.info", NULL, 1960354, 339, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.log", NULL, 1960693, 2473, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.misc_util", NULL, 1963166, 67322, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.npy_pkg_config", NULL, 2030488, 12416, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.unixccompiler", NULL, 2042904, 3392, NUITKA_BYTECODE_FLAG },
    ...
    { "numpy.testing", NULL, 2046296, 812, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.testing._private", NULL, 2047108, 154, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.testing._private.decorators", NULL, 2047262, 9141, NUITKA_BYTECODE_FLAG },
    { "numpy.testing._private.nosetester", NULL, 2056403, 15404, NUITKA_BYTECODE_FLAG },
    { "numpy.testing._private.utils", NULL, 2071807, 64594, NUITKA_BYTECODE_FLAG },
    ...
    { "packaging.__about__", MOD_INIT_NAME( packaging$__about__ ), 0, 0, NUITKA_COMPILED_MODULE },
    { "packaging._compat", MOD_INIT_NAME( packaging$_compat ), 0, 0, NUITKA_COMPILED_MODULE },
    { "packaging._structures", MOD_INIT_NAME( packaging$_structures ), 0, 0, NUITKA_COMPILED_MODULE },
    { "packaging.markers", MOD_INIT_NAME( packaging$markers ), 0, 0, NUITKA_COMPILED_MODULE },
    { "packaging.requirements", MOD_INIT_NAME( packaging$requirements ), 0, 0, NUITKA_COMPILED_MODULE },
    { "packaging.specifiers", MOD_INIT_NAME( packaging$specifiers ), 0, 0, NUITKA_COMPILED_MODULE },
    { "packaging.version", MOD_INIT_NAME( packaging$version ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pkg_resources", NULL, 2136401, 99398, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources.py31compat", NULL, 2235799, 550, NUITKA_BYTECODE_FLAG },
    { "pos_vec", MOD_INIT_NAME( pos_vec ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "track", MOD_INIT_NAME( track ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
