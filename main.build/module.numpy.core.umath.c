...
static PyObject *const_str_digest_a247bb65e35ab853a22b170235d5935f;
...
{
    const_str_digest_a247bb65e35ab853a22b170235d5935f = UNSTREAM_STRING_ASCII( &constant_bin[ 592034 ], 68, 0 );
    const_str_plain__UFUNC_API = UNSTREAM_STRING_ASCII( &constant_bin[ 592102 ], 10, 1 );
    const_str_plain__arg = UNSTREAM_STRING_ASCII( &constant_bin[ 23167 ], 4, 1 );
    const_str_digest_3e88d91bb93ab98c833af948b91d82f5 = UNSTREAM_STRING_ASCII( &constant_bin[ 592112 ], 258, 0 );
    const_list_6b698367cfa3fe41b9df413e98d356ea_list = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 592370 ], 1149 );
    const_str_digest_d9b69e3862225d0d854b898036cd01f1 = UNSTREAM_STRING_ASCII( &constant_bin[ 593519 ], 25, 0 );
    const_str_plain__ones_like = UNSTREAM_STRING_ASCII( &constant_bin[ 546630 ], 10, 1 );
...
static PyCodeObject *codeobj_2e659ec7e695857e785aa4de7bacab6d;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_a247bb65e35ab853a22b170235d5935f;
    codeobj_2e659ec7e695857e785aa4de7bacab6d = MAKE_CODEOBJ( module_filename_obj, const_str_digest_d9b69e3862225d0d854b898036cd01f1, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_2e659ec7e695857e785aa4de7bacab6d;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_a247bb65e35ab853a22b170235d5935f;
        UPDATE_STRING_DICT0( moduledict_numpy$core$umath, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    }
    // Frame without reuse.
    frame_2e659ec7e695857e785aa4de7bacab6d = MAKE_MODULE_FRAME( codeobj_2e659ec7e695857e785aa4de7bacab6d, module_numpy$core$umath );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_2e659ec7e695857e785aa4de7bacab6d );
    assert( Py_REFCNT( frame_2e659ec7e695857e785aa4de7bacab6d ) == 2 );
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_a247bb65e35ab853a22b170235d5935f;
    ...
    }
    {
        ...
        frame_2e659ec7e695857e785aa4de7bacab6d->m_frame.f_lineno = 9;
    ...
    }
    {
        ...
        frame_2e659ec7e695857e785aa4de7bacab6d->m_frame.f_lineno = 10;
    ...
    }
    {
        ...
        frame_2e659ec7e695857e785aa4de7bacab6d->m_frame.f_lineno = 11;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_2e659ec7e695857e785aa4de7bacab6d );
#endif
    popFrameStack();

    assertFrameObject( frame_2e659ec7e695857e785aa4de7bacab6d );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_2e659ec7e695857e785aa4de7bacab6d, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_2e659ec7e695857e785aa4de7bacab6d->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_2e659ec7e695857e785aa4de7bacab6d, exception_lineno );
    }
