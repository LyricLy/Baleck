...
static PyObject *const_str_digest_4bb8d6e8b48377b6018245506d2d902b;
...
{
    const_str_digest_4bb8d6e8b48377b6018245506d2d902b = UNSTREAM_STRING_ASCII( &constant_bin[ 1118932 ], 69, 0 );
    const_str_digest_89e693285590e79430d162136a6b4413 = UNSTREAM_STRING_ASCII( &constant_bin[ 1119001 ], 1104, 0 );
    const_str_digest_02415e64e2eb2af89d58930190432cd8 = UNSTREAM_STRING_ASCII( &constant_bin[ 1120105 ], 17, 0 );
    const_str_digest_fc62ac7c06e1cf627e844d703ca23411 = UNSTREAM_STRING_ASCII( &constant_bin[ 1120122 ], 26, 0 );
...
static PyCodeObject *codeobj_eb43985fc68f51760d62dfc0b3679855;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_4bb8d6e8b48377b6018245506d2d902b;
    codeobj_eb43985fc68f51760d62dfc0b3679855 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_fc62ac7c06e1cf627e844d703ca23411, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_eb43985fc68f51760d62dfc0b3679855;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_4bb8d6e8b48377b6018245506d2d902b;
        UPDATE_STRING_DICT0( moduledict_numpy$linalg$info, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    }
    // Frame without reuse.
    frame_eb43985fc68f51760d62dfc0b3679855 = MAKE_MODULE_FRAME( codeobj_eb43985fc68f51760d62dfc0b3679855, module_numpy$linalg$info );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_eb43985fc68f51760d62dfc0b3679855 );
    assert( Py_REFCNT( frame_eb43985fc68f51760d62dfc0b3679855 ) == 2 );
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_4bb8d6e8b48377b6018245506d2d902b;
    ...
    }
    {
        ...
        frame_eb43985fc68f51760d62dfc0b3679855->m_frame.f_lineno = 35;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_eb43985fc68f51760d62dfc0b3679855 );
#endif
    popFrameStack();

    assertFrameObject( frame_eb43985fc68f51760d62dfc0b3679855 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_eb43985fc68f51760d62dfc0b3679855, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_eb43985fc68f51760d62dfc0b3679855->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_eb43985fc68f51760d62dfc0b3679855, exception_lineno );
    }
